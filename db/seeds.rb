...
Flat.create!(
  ...
  price_per_night: 75,
  number_of_guests: 3,
  photo: "url('https://images.unsplash.com/photo-1494526585095-c41746248156?w=1200')"
)
...
Flat.create!(
  ...
  price_per_night: 65,
  number_of_guests: 2,
  photo: "url('https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1200')"
)
...
Flat.create!(
  ...
  price_per_night: 110,
  number_of_guests: 2,
  photo: "url('https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=1200')"
)
